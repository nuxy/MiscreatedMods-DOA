...
function DroneCrash:OnInit()
	self:OnReset();
end

function DroneCrash:OnPropertyChange()
	self:OnReset();
end

function DroneCrash:OnReset()
end

function DroneCrash:OnShutDown()
end

-- Called when the crash happens on the server
function DroneCrash:OnCrashed()
	--Log("DroneCrash - OnCrashed")
...
SpawnAirPlaneCrashLoot = function(self)
	--Log("DroneCrash - SpawnAirPlaneCrashLoot")
